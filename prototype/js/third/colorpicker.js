...
define(function(require , exports , module){
    ...
    Raphael.colorpicker = function (x, y, size, initcolor, element , relativeElm) {
        return new ColorPicker(x, y, size, initcolor, element , relativeElm);
    };
    ...
    var doc = document, win = window,
        ColorPicker = function (x, y, size, initcolor, element) {
            ...
            t.disc.drag(function (dx, dy, x, y) {
                ...
                t.docOnMove(dx, dy, x - offset.left + gapx, y - offset.top + gapy);
            }, function (x, y) {
                var scrollY = doc.documentElement.scrollTop || doc.body.scrollTop,
                    scrollX = doc.documentElement.scrollLeft || doc.body.scrollLeft,
					offset = $(element).offset();
                t.hsOnTheMove = true;
                t.setHS(x + scrollX - t.x - offset.left + gapx, y + scrollY - t.y - offset.top + gapy);
            }, function () {
                t.hsOnTheMove = false;
            });
            t.btop.drag(function (dx, dy, x, y) {
                ...
                var scrollX = doc.documentElement.scrollLeft || doc.body.scrollLeft,
					offset = $(element).offset();
                t.bOnTheMove = true;
                t.setB(x + scrollX - t.x - offset.left + gapx);
            }, function () {
                t.bOnTheMove = false;
            });
